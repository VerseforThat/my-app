...
export default function SearchScreen() {
  ...
  const runSearch = async (text: string) => {
    ...
    const q = text.trim();
    if (q.length < 1) {
      setError('Type a verse reference or a topic.');
      return;
    }
    setError('');
    setLoading(true);
          ...
          >
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>
                ...
                <Text style={styles.subtitleStrong}>"John 3:16"</Text> or a topic like{' '}
                <Text style={styles.subtitleStrong}>"patience"</Text>.
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  searchBtnText: { color: colors.bg, fontFamily: fonts.sansMedium, fontSize: 15, letterSpacing: 0.3 },
  ...
  resultRef: { fontFamily: fonts.sansSemi, fontSize: 12, letterSpacing: 1.5, color: colors.accent, marginBottom: 10 },
