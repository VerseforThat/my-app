...
const styles = StyleSheet.create({
  ...
  btn: { marginTop: 32, backgroundColor: colors.textPrimary, borderRadius: radii.pill, paddingVertical: 18, alignItems: 'center' },
  btnText: { color: colors.bg, fontFamily: fonts.sansMedium, fontSize: 16, letterSpacing: 0.3 },
